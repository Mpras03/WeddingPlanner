...
export class SaveCustomerProfileDto {
  @ApiProperty({
    description: 'Id user pemilik customer profile ini',
    example: 1,
  })
  @Type(() => Number)
  @IsInt()
  ...
  @ApiPropertyOptional({
    description:
      'Kategori vendor yang dibutuhkan (dikirim sebagai JSON array string di form-data)',
  ...
  @ApiPropertyOptional({
    description:
      'Prioritas budget (dikirim sebagai JSON array string di form-data)',
